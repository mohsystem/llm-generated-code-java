...
public class CompilerWithDependencies {

    private static final Map<String, Integer> summary = new HashMap<>();

    public static void main(String[] args) {
        // Set the source and output directories
        String sourceDirectory = "generatedCode/gemini"; // Update this path
        String outputDirectory = "out"; // Update this path
        String libDirectory = "lib"; // Directory containing external JAR files

        try {
            compileJavaFiles(sourceDirectory, outputDirectory, libDirectory);
            printSummary();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void compileJavaFiles(String sourceDir, String outputDir, String libDir) throws IOException {
        ...
        // Get the list of JAR files in the lib directory
        ...
        String classpath = jarFiles.stream()
                .map(File::getPath)
