...
import gtp4o.task2.Task2_OPENAI_gpt_4o;
...
class Task2_TestCase {
    ...
    void testCreatePhoneNumber(int[] input, String expected, String testName) {
        String result = Task2_PERPLEXITY_llama_3_sonar_large_32k_chat.createPhoneNumber(input);
    ...
    void testInvalidInput() {
        ...
        try {
            Task2_PERPLEXITY_llama_3_sonar_large_32k_chat.createPhoneNumber(invalidInput);
