...
import llama3.task29.Task29_PERPLEXITY_llama_3_sonar_large_32k_chat;
...
public class Task29_TestCase {
    ...
    void testCase1() {
        ...
        assertArrayEquals(expected, Task29_PERPLEXITY_llama_3_sonar_large_32k_chat.twoSum(numbers, target));
    }
