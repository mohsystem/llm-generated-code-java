...
import static llama3.task18.Task18_PERPLEXITY_llama_3_sonar_large_32k_chat.binaryArrayToNumber;
...
public class Task18_TestCase {
    ...
    void testBinary6() {
        ...
        assertEquals(6,  binaryArrayToNumber(new int[]{0, 1, 1, 0}));
    }

    @Test
    void testBinary15() {
        // Test with an array where the binary value is 15
        assertEquals(15, binaryArrayToNumber(new int[]{1, 1, 1, 1}));
    }

    @Test
    void testBinary11() {
        // Test with an array where the binary value is 11
        assertEquals(11, binaryArrayToNumber(new int[]{1, 0, 1, 1}));
    }

    @Test
    void testSingleBit1() {
        // Test with an array representing a single bit of 1
        assertEquals(1, binaryArrayToNumber(new int[]{1}));
    }

    @Test
    void testSingleBit0() {
        // Test with an array representing a single bit of 0
        assertEquals(0, binaryArrayToNumber(new int[]{0}));
    }

    @Test
    void testLongerArray() {
        // Test with a longer array representing binary 43
        assertEquals(43, binaryArrayToNumber(new int[]{0, 1, 0, 1, 0, 1, 1}));
    }
}
