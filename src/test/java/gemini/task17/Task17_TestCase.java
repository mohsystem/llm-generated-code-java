...
import gemini.task17.Task17_GEMINI_gemini_1_5_pro_001;
...
public class Task17_TestCase {
    ...
    void testCase1() {
        ...
        assertEquals(expected, new Task17_GEMINI_gemini_1_5_pro_001().toJadenCase(phrase));
    }
    ...
    void testCase9() {
        String phrase = "";
        assertNull(new Task17_GEMINI_gemini_1_5_pro_001().toJadenCase(phrase));
    }
