...
public class Task175Test {
    ...
    public void testCase7() {
        int[] arrData = new int[19999];
        for (int i = 0; i < 10000; i++) arrData[i] = i + 1;
        for (int i = 10000, val = 9999; i < 19999; i++, val--) arrData[i] = val;
        MountainArray arr = new MountainArray(arrData);
