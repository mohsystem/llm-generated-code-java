...
import codestral.task2.Task2_MISTRAL_codestral_latest;
...
class Task2_TestCase {
    ...
    void testCreatePhoneNumber(int[] input, String expected, String testName) {
        String result = Task2_GEMINI_gemini_1_5_pro_001.createPhoneNumber(input);
    ...
    void testInvalidInput() {
        ...
        try {
            Task2_GEMINI_gemini_1_5_pro_001.createPhoneNumber(invalidInput);
