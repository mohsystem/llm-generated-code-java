...
public class Task124Test {
    ...
    private final SensitiveData storage = new SensitiveData();
    ...
    public Task124Test() {
        ...
        // Store all data in SensitiveData object (simulating storage)
        for (Map.Entry<String, String> entry : sensitiveData.entrySet()) {
            storage.storeData(entry.getKey(), entry.getValue());
        }
    }
