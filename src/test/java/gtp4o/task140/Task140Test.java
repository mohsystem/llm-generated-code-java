...
class Task140Test {
    ...
    private void runMain() {
        Task140_OPENAI_gpt_4o.main(new String[]{});
    }
    ...
    void testDivisionByZero() {
        provideInput("5\n0\n/\n");
        runMain();
        // لأن جافا بتحسب 5/0 = Infinity، بنتحقق من وجود Infinity
        assertTrue(getOutput().contains("Infinity"));
    }
    ...
    void testInvalidOperator() {
        ...
        assertTrue(getOutput().contains("Result: 0.0"));
    }
    ...
    void testFloatNumbersMultiplication() {
        provideInput("5.5\n2.2\n*\n");
        runMain();
        assertTrue(getOutput().contains("Result: 12.100000000000001") || getOutput().contains("12.1"));
    }
}
