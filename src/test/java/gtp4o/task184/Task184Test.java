...
public class Task184Test {
    ...
    private String getName(Task184_OPENAI_gpt_4o robot) throws NoSuchFieldException, IllegalAccessException {
        Field nameField = Task184_OPENAI_gpt_4o.class.getDeclaredField("name");
