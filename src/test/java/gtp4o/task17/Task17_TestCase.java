...
import gtp4o.task17.Task17_OPENAI_gpt_4o;
...
public class Task17_TestCase {
    ...
    void testCase1() {
        ...
        assertEquals(expected, new Task17_OPENAI_gpt_4o().toJadenCase(phrase));
    }
    ...
    void testCase9() {
        String phrase = "";
        assertNull(new Task17_OPENAI_gpt_4o().toJadenCase(phrase));
    }
