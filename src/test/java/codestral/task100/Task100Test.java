...
public class Task100Test {
    ...
    private String runMain(String pattern) throws IOException {
        ...
        Task100_MISTRAL_codestral_latest.main(new String[]{pattern, TEST_FILE});
    ...
    public void testMatchApple() throws IOException {
        ...
        // Should match "apple" from "apple pie" and "pineapple tart"
    ...
    public void testFileNotFound() throws IOException {
        ...
        Task100_MISTRAL_codestral_latest.main(new String[]{"apple", "notfound.txt"});
