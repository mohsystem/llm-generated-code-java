...
class Task146Test {
    ...
    void testMissingNumberAtStart() {
        int[] arr = {2, 3, 4, 5, 6};
        assertEquals(1, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }

    @Test
    void testMissingNumberAtEnd() {
        int[] arr = {1, 2, 3, 4, 5};
        assertEquals(6, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }

    @Test
    void testMissingNumberInMiddle() {
        int[] arr = {1, 2, 4, 5, 6};
        assertEquals(3, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }
    ...
    void testMissingNumberInLargeArray() {
        ...
        assertEquals(5000, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }

    @Test
    void testSingleMissingNumber() {
        int[] arr = {1};
        assertEquals(2, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }
    ...
    void testConsecutiveNumbersMissingOne() {
        ...
        assertEquals(12, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }

    @Test
    void testMissingNumberAtEndOfSmallArray() {
        int[] arr = {1, 2, 3, 4};
        assertEquals(5, Task146_MISTRAL_codestral_latest.findMissing(arr));
    }
