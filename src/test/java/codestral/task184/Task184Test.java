...
public class Task184Test {
    ...
    private String getName(Task184_MISTRAL_codestral_latest robot) throws NoSuchFieldException, IllegalAccessException {
        Field nameField = Task184_MISTRAL_codestral_latest.class.getDeclaredField("name");
    ...
    public void testNameIsUniqueOnCreation() throws NoSuchFieldException, IllegalAccessException {
        Task184_MISTRAL_codestral_latest robot = new Task184_MISTRAL_codestral_latest();
    ...
    public void testResetGeneratesNewName() throws NoSuchFieldException, IllegalAccessException {
        ...
        // Simulate reset by creating a new instance
        robot = new Task184_MISTRAL_codestral_latest();
