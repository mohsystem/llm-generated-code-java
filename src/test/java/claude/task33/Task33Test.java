...
public class Task33Test {
    ...
    void testLongQueue() {
        ...
        assertEquals(28, queueTime(new int[]{2, 2, 3, 3, 4, 4, 5, 5}, 1));//todo fix for python
    }

    @Test
    void testComplexDistribution() {
        // Complex distribution of customers
        assertEquals(5, queueTime(new int[]{2, 3, 4, 3, 2, 1}, 3));//todo fix for python
    }

    @Test
    void testHighNumberOfTills() {
        // High number of tills, fewer customers
        assertEquals(1, queueTime(new int[]{1, 1, 1, 1, 1, 1}, 10));//todo fix for python
    }
}
