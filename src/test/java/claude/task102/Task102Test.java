...
public class Task102Test {
    ...
    @Test
    public void testUpdatePassword_alice() throws SQLException {
        runAndAssert("alice", "mypassword123", "6e659deaa85842cdabb5c6305fcc40033ba43772ec00d45c2a3c921741a5e377");
    }

    @Test
    public void testUpdatePassword_bob() throws SQLException {
        runAndAssert("bob", "Secure!Pass456", "9acd647df4d52296793a7b295c4be95cc11ecb2a9d7671a8dac5ea09a6ba67a3");
    }

    @Test
    public void testUpdatePassword_charlie() throws SQLException {
        runAndAssert("charlie", "123456", "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92");
    }

    private void runAndAssert(String username, String password, String expectedHash) throws SQLException {
        Task102_CLAUDE_claude_3_5_sonnet_20240620.updatePassword(username, password);
