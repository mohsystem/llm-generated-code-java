...
import claude.task1.Task1_CLAUDE_claude_3_5_sonnet_20240620;
...
class Task2_ClaudeTestCase {
    ...
    void testCreatePhoneNumber(int[] input, String expected, String testName) {
        String result = Task2_CLAUDE_claude_3_5_sonnet_20240620.createPhoneNumber(input);
    ...
    private static Stream<Arguments> phoneNumberTestCases() {
        return Stream.of(
                ...
                Arguments.of(new int[]{1, 1, 1, 1, 1, 1, 1, 1, 1, 2}, "(111) 111-1112", "Edge case (all same digit except one)")
        );
    }
    ...
    void testInvalidInput() {
        ...
        try {
            Task2_CLAUDE_claude_3_5_sonnet_20240620.createPhoneNumber(invalidInput);
