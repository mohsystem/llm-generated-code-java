...
public class Task124Test {
    ...
    public void test_encrypt_credit_card() {
        ...
        try {
            ...
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_credit_card: PASS");
            } else {
    ...
    public void test_encrypt_ssn() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_ssn: PASS");
            } else {
    ...
    public void test_encrypt_password() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_password: PASS");
            } else {
    ...
    public void test_encrypt_empty_string() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_empty_string: PASS");
            } else {
    ...
    public void test_encrypt_special_characters() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_special_characters: PASS");
            } else {
    ...
    public void test_decrypt_empty_string() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_decrypt_empty_string: PASS");
            } else {
    ...
    public void test_encrypt_decrypt_with_long_string() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_decrypt_with_long_string: PASS");
            } else {
    ...
    public void test_encrypt_decrypt_with_numeric_string() {
        ...
        try {
            ...
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_decrypt_with_numeric_string: PASS");
            } else {
    ...
    public void test_encrypt_decrypt_with_unicode() {
        String data = "こんにちは"; // Japanese for "Hello"
        try {
            String encrypted = EncryptionHelper.encrypt(data);
            String decrypted = EncryptionHelper.decrypt(encrypted);
            if (decrypted.equals(data)) {
                System.out.println("test_encrypt_decrypt_with_unicode: PASS");
            } else {
