...
public class Task166Test {
    ...
    public void test_case_1() {
        List<Integer> input = Arrays.asList(6, 3, -2, 5, -8, 2, -2);
        List<Integer> expected = Arrays.asList(2, 3, -2, 5, -8, 6, -2);
        assertEquals(expected, Task166_CLAUDE_claude_3_5_sonnet_20240620.posNegSort(input));
    }

    @Test
    public void test_case_2() {
        List<Integer> input = Arrays.asList(6, 5, 4, -1, 3, 2, -1, 1);
    ...
    public void test_case_3() {
        List<Integer> input = Arrays.asList(-5, -5, -5, -5, 7, -5);
    ...
    public void test_case_5() {
        List<Integer> input = Arrays.asList(10, -10, 20, -20);
    ...
    public void test_case_6() {
        List<Integer> input = Arrays.asList(9, 3, -3, -2, 7);
    ...
    public void test_case_7() {
        List<Integer> input = Arrays.asList(5, 4, -1, -2, 1);
    ...
    public void test_case_9() {
        List<Integer> input = Arrays.asList(100, -50, 75, -25);
    ...
    public void test_case_10() {
        List<Integer> input = Arrays.asList(2, 1, -9, -8);
