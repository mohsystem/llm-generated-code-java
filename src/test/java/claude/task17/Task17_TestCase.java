...
public class Task17_TestCase {
    ...
    void testCase1() {
        ...
        assertEquals(expected, new Task17_CLAUDE_claude_3_5_sonnet_20240620().toJadenCase(phrase));
    }
    ...
    void testCase9() {
        String phrase = "";
        assertNull(new Task17_CLAUDE_claude_3_5_sonnet_20240620().toJadenCase(phrase));
    }
