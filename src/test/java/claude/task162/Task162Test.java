...
public class Task162Test {
    ...
    void testSingleNodeGraph() {
        ...
        assertEquals(expected, Task162_CLAUDE_claude_3_5_sonnet_20240620.dijkstra(graph, "A"));
    }
    ...
    @Test
    @DisplayName("Unreachable nodes from non-start")
    void testUnreachableFromStart() {
        Map<String, Map<String, Integer>> graph = new HashMap<>();
        graph.put("A", new HashMap<>());
        graph.get("A").put("B", 1);
        graph.put("B", new HashMap<>());
