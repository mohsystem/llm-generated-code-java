...
public class Task176Test {
    ...
    void testCase1_basicAddAndGet() {
        ...
        assertEquals(20, productOfNumbers.getProduct(2)); // 5 * 4
    }
    ...
    void testCase2_getLastThree() {
        ...
        productOfNumbers.add(5);
        productOfNumbers.add(4);
        assertEquals(40, productOfNumbers.getProduct(3)); // 2 * 5 * 4
    }
    ...
    void testCase3_getLastFourIncludesZero() {
        ...
        productOfNumbers.add(5);
        productOfNumbers.add(4);
        assertEquals(0, productOfNumbers.getProduct(4)); // 0 * 2 * 5 * 4
    }
    ...
    void testCase4_addAfterZero() {
        ...
        assertEquals(32, productOfNumbers.getProduct(2)); // 4 * 8
    }
    ...
    void testCase5_getLastThreeAfterMoreAdds() {
        ...
        assertEquals(192, productOfNumbers.getProduct(3)); // 8 * 6 * 4
    }
    ...
    void testCase8_lastFourAfterZero() {
        ...
        productOfNumbers.add(3);
        productOfNumbers.add(4);
        assertEquals(24, productOfNumbers.getProduct(4)); // 1 * 2 * 3 * 4
    }
    ...
    void testCase9_noZeros() {
        ...
        productOfNumbers.add(4);
        productOfNumbers.add(5);
        assertEquals(60, productOfNumbers.getProduct(3)); // 3 * 4 * 5
    }
    ...
    void testCase10_zeroAfterMany() {
        ...
        productOfNumbers.add(5);
        productOfNumbers.add(0);
        assertEquals(0, productOfNumbers.getProduct(2)); // 0 * 5
    }
}
